...
ThemeData getApplicationTheme(){
  return ThemeData(
    ...
    textTheme: TextTheme(
      ...
      titleMedium: getMediumStyle(color: ColorManager.mediumPrimary, fontSize: FontSize.s14),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      hintStyle: getRegularStyle(color: ColorManager.grey2, fontSize: FontSize.s14),
      labelStyle: getMediumStyle(color: ColorManager.grey2, fontSize: FontSize.s14),
      errorStyle: getRegularStyle(color: ColorManager.error),
      enabledBorder: OutlineInputBorder(
        borderSide: BorderSide(color: ColorManager.grey2, width: AppSize.s1_5),
